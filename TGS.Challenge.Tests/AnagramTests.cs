...
namespace TGS.Challenge.Tests
{
    ...
    public class AnagramTests
    {
        ...
        {
            Assert.Throws<ArgumentNullException>(() => _anagram.AreAnagrams(string.Empty, "ABC"));
        }

        [Test()]
        public void Word2_IsRequired()
        {
            Assert.Throws<ArgumentNullException>(() => _anagram.AreAnagrams("ABC", string.Empty));
        }

        [Test()]
        public void Dormitory_IsNotAnagram_Dirty_room()
        {
        ...
        [Test()]
        public void Funeral_IsNotAnagram_Reel_fun()
        {
